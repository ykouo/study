	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<section>
					<header class="main">
						<h1><%=user.getMid()%>님의 회원정보 수정 페이지 입니다.
						</h1>
					</header>
					<form action="control.jsp" method="post">
						<input type="hidden" name="action" value="editUserInfo"> <input
							type="hidden" name="mnum" value="<%=user.getMnum()%>">
						<table>
							<tr>
								<td>아이디 *</td>
								<td><input type="text" name="mid"
									value="<%=user.getMid()%>"></td>
							</tr>
							<tr>
								<td>닉네임 *</td>
								<td><input type="text" name="mname"
									value="<%=user.getMname()%>"></td>
							</tr>
							<tr>
								<td>비밀번호*</td>
								<td><input type="password" name="mpw"
									value="<%=user.getMpw()%>"></td>
							</tr>
