			...
			<div class="inner">
				...
				<section>
					...
					<form action="control.jsp" method="post">
						<input type="hidden" name="action" value="insertPost"> <input
							type="hidden" name="pwriter" value="<%=user.getMname()%>">

						<input type="hidden" name="action" value="insertPost">
						<div class="col-12">
							<ul class="actions">
								<li><input type="text" name="ptitle" placeholder="제목작성"></li>
								<li><input type="text" name="pcontent"
									style="width: 200px; height: 200px;" placeholder="내용작성"></li>
								<li><td><input type="submit" value="글올리기"></li>
							</ul>
						</div>
					</form>
