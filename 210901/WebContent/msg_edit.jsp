<%@page import="model.message.MessageVO"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="mem" class = "model.member.MemberVO" scope="application"/>    
<jsp:useBean id="data" class = "model.message.MessageVO" scope="request"/>    
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>글수정/삭제 페이지</title>
<style type="text/css">
table,tr,td{
...
function check(mnum){
	pw = prompt("글 정보변경을 위해 비밀번호를 입력하세요:D");
	document.location.href="mem_cotrol.jsp?action=edit&mnum="+mnum+"&pw="+pw;
}
